...
app_include_js = "/assets/propms/js/propms_help_modal.js"
...
scheduler_events = {
    "daily": [
        ...
        "propms.property_management_solution.doctype.property_document.property_document.mark_expiring_documents",
    ],
